...
bpmp::PredictionVisualizer::PredictionVisualizer() {

}

void bpmp::PredictionVisualizer::UpdateParameter(const bpmp::VisualizationParam &param) {
    param_ = param;
    // RAW PRIMITIVE
...
bpmp::PredictionVisualizer::VisualizeRawPrimitives(const std::vector<bpmp::PrimitiveTarget> &primitive) {
...
visualization_msgs::MarkerArray
bpmp::PredictionVisualizer::VisualizeFeasiblePrimitives(const std::vector<bpmp::PrimitiveTarget> &primitive,
                                                        const std::vector<uint> &feasible_index) {
    visualization_msgs::MarkerArray visual_output;
...
bpmp::PredictionVisualizer::VisualizeBestPrimitive(const std::vector<bpmp::PrimitiveTarget> &primitive,
...
//        printf("BEST PRIMITIVE POINT SIZE: %d -th x: %f, y: %f, z: %f\n",i, temp_point.x,temp_point.y,temp_point.z);
    }
