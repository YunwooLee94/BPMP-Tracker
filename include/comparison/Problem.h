...
namespace bpmp{
    ...
    public:
        ...
        Problem(const bpmp::TargetStateBaseline& target_state,
                ...
                const bpmp::UnicycleStateBaseline& tracker_state)
        ...
        const bpmp::UnicycleStateBaseline& tracker_state() const { return tracker_state_; }

    private:
        bpmp::TargetStateBaseline target_state_;
        std::vector<bpmp::State> obstacle_state_list_;
        bpmp::UnicycleStateBaseline tracker_state_;
    };
}
